...
//	static final String DIALOG_SETTING_FILE = "userInfo.xml";
	...
	public ReservationWizard()
	{
		...
		setDefaultPageImageDescriptor(ImageDescriptor.createFromFile(null, 
				"C:/mydocs/robin/Project/flca/projects/com.flca.mda/FlcaMdaCodegen/src-test/icons/hotel.gif"));
...
public class TestWizzard extends ApplicationWindow
{
	/*
	 * (non-Javadoc)
	 * 
	 ...
	 * @param parentShell
	 */
	public TestWizzard(Shell parentShell)
	{
		super(parentShell);
	}
	...
	{
		TestWizzard reservation = new TestWizzard(null);
